...
namespace TelegramClient.Core.Utils
{
    ...
    public class Crc32
    {
        ...
        /// <summary>Create an instance of the CRC32 class, specifying whether to reverse data bits or not.</summary>
        /// <param name='reverseBits'>specify true if the instance should reverse data bits.</param>
        /// <remarks>
        ///     <para>
        ///         In the CRC-32 used by BZip2, the bits are reversed. Therefore if you want a CRC32 with compatibility with
        ///         BZip2, you should pass true here. In the CRC-32 used by GZIP and PKZIP, the bits are not reversed; Therefore if
        ///         you want a CRC32 with compatibility with those, you should pass false.
        ///     </para>
        /// </remarks>
        ...
        /// <summary>Create an instance of the CRC32 class, specifying the polynomial and whether to reverse data bits or not.</summary>
        /// <param name='polynomial'>
        ///     The polynomial to use for the CRC, expressed in the reversed (LSB) format: the highest ordered
        ///     bit in the polynomial value is the coefficient of the 0th power; the second-highest order bit is the coefficient of
        ///     the 1 power, and so on. Expressed this way, the polynomial for the CRC-32C used in IEEE 802.3, is 0xEDB88320.
        /// </param>
        /// <param name='reverseBits'>specify true if the instance should reverse data bits.</param>
        /// <remarks>
        ///     <para>
        ///         In the CRC-32 used by BZip2, the bits are reversed. Therefore if you want a CRC32 with compatibility with
        ///         BZip2, you should pass true here for the <c>reverseBits</c> parameter. In the CRC-32 used by GZIP and PKZIP,
        ///         the bits are not reversed; Therefore if you want a CRC32 with compatibility with those, you should pass false
        ///         for the <c>reverseBits</c> parameter.
        ///     </para>
        /// </remarks>
        ...
        /// <summary>
        ///     Get the CRC32 for the given (word,byte) combo.  This is a computation defined by PKzip for PKZIP 2.0 (weak)
        ///     encryption.
        /// </summary>
        ...
        /// <summary>Reset the CRC-32 class - clear the CRC "remainder register."</summary>
        /// <remarks>
        ///     <para>
        ///         Use this when employing a single instance of this class to compute multiple, distinct CRCs on multiple,
        ...
        /// <remarks>
        ///     <para>
        ///         This method serves as an optimization for updating the CRC when a run of identical bytes is found. Rather
        ///         than passing in a buffer of length n, containing all identical bytes b, this method accepts the byte value and
        ///         the length of the (virtual) buffer - the length of the run.
        ///     </para>
        /// </remarks>
        /// <param name="b">the byte to include into the CRC.  </param>
    ...
    /// <summary>A Stream that calculates a CRC32 (a checksum) on all bytes read, or on all bytes written.</summary>
    /// <remarks>
    ///     <para>
    ///         This class can be used to verify the CRC of a ZipEntry when reading from a stream, or to calculate a CRC when
    ///         writing to a stream.  The stream should be used to either read, or write, but not both.  If you intermix reads
    ///         and writes, the results are not defined.
    ///     </para>
                                       ...
                                       IDisposable
    {
        ...
        /// <summary>Gets the total number of bytes run through the CRC32 calculator.</summary>
        /// <remarks>
        ...
        /// <remarks>
        ///     <para>
        ///         The running total of the CRC is kept as data is written or read through the stream.  read this property after
        ///         all reads or writes to get an accurate CRC for the entire stream.
        ///     </para>
        /// </remarks>
        public int Crc => _crc32.Crc32Result;

        /// <summary>Indicates whether the underlying stream will be left open when the <c>CrcCalculatorStream</c> is Closed.</summary>
        /// <remarks>
        ...
        /// <summary>
        ///     The getter for this property returns the total bytes read. If you use the setter, it will throw
        ...
        /// <remarks>
        ///     <para>
        ///         Instances returned from this constructor will leave the underlying stream open upon Close().  The stream uses
        ///         the default CRC32 algorithm, which implies a polynomial of 0xEDB88320.
        ///     </para>
        /// </remarks>
        ...
        /// <summary>The constructor allows the caller to specify how to handle the underlying stream at close.</summary>
        /// <remarks>
        ///     <para>The stream uses the default CRC32 algorithm, which implies a polynomial of 0xEDB88320.</para>
        /// </remarks>
        /// <param name="stream">The underlying stream</param>
        /// <param name="leaveOpen">
        ///     true to leave the underlying stream open upon close of the <c>CrcCalculatorStream</c>; false
        ///     otherwise.
        /// </param>
        ...
        /// <summary>A constructor allowing the specification of the length of the stream to read.</summary>
        /// <remarks>
        ///     <para>The stream uses the default CRC32 algorithm, which implies a polynomial of 0xEDB88320.</para>
        ///     <para>Instances returned from this constructor will leave the underlying stream open upon Close().</para>
        /// </remarks>
        /// <param name="stream">The underlying stream</param>
        ...
        /// <summary>
        ///     A constructor allowing the specification of the length of the stream to read, as well as whether to keep the
        ///     underlying stream open upon Close().
        /// </summary>
        /// <remarks>
        ///     <para>The stream uses the default CRC32 algorithm, which implies a polynomial of 0xEDB88320.</para>
        /// </remarks>
        ...
        /// <summary>
        ///     A constructor allowing the specification of the length of the stream to read, as well as whether to keep the
        ///     underlying stream open upon Close(), and the CRC32 instance to use.
        /// </summary>
        /// <remarks>
        ///     <para>
        ///         The stream uses the specified CRC32 instance, which allows the application to specify how the CRC gets
        ///         calculated.
        ///     </para>
        /// </remarks>
        /// <param name="stream">The underlying stream</param>
        ...
        /// <summary>This method always throws <see cref="NotSupportedException" /></summary>
